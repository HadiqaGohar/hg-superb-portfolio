  ...
  return (
    <div className='lg:h-[805px] max-h-screen flex flex-col md:flex-row text-white bg-[#0B2447] w-full'>
      ...
      <div className='my-auto md:my-40 md:mx-24 lg:mx-32 text-center md:text-left md:flex-1'>
        ...
        {/* Buttons */}
        <div className='my-8 flex flex-row gap-4 justify-center md:justify-start text-center animate-slide animate-delay-1'>
          <Link href="/cv">
            <button className="bg-[#19A7CE] font-bold italic hover:bg-transparent hover:border-[#19A7CE] hover:border-2 hover:text-[#19A7CE] text-black px-4 py-2 rounded">
              Download CV
            </button>
          </Link>
          <div>
