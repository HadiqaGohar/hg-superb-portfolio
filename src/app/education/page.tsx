...
const educationData = [
    {
        year: '2021 - 2022',
        title: 'Matric of Science Biology',
        description:'Completed school with a focus on science and mathematics.',
    },
    {
        year: '2023 - 2024',
        title: 'Intermediate (pre-medical)',
        description: 'Completed College with a focus on sci (Medical) at G.I.S.A.C.C.',
    },
    {
        year: '2024 - 2025',
        title: 'Generative AI',
        description: 'Started my journey in AI at GIAIC, gaining valuable experience.',
    },
];
        ...
        <section className="education py-20 bg-[#1C315E] text-white">
            ...
            <div className="timeline-items relative max-w-4xl mx-auto">
                ...
                {educationData.map((item, index) => (
                    <div
                        key={index}
                        className={`timeline-item relative mb-10 ${index % 2 === 0 ? 'text-right' : 'text-left'}`}
                    >
